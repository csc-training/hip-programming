...
* Using 240 blocks (2 x 120 CUs) and 256 threads per block provides good performance, maybe additional tuning required
...
* Its API is available to other profiling tools such as HPCToolkit, TAU, SCORE-P
